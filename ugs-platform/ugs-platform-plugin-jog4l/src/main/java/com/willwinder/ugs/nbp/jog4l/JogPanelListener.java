...
public interface JogPanelListener {
     ...
     */
    void onStepSizeVertChanged(double value);
     ...
     * @param value the step size
     */
    void onStepSizeHorzChanged(double value);
     ...
     * @param value the step size
     */
    void onStepSizeRotChanged(double value);
    ...
    /**
     * Toggles the linking of axes
     */
    void onToggleLinkedAxes();
