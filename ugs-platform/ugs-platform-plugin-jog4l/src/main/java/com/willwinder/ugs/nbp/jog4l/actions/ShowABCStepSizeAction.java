...
@ActionID(
        ...
        id = "com.willwinder.ugs.nbp.jog4l.actions.ShowABCStepSizeAction")
@ActionRegistration(
        displayName = "resources.MessagesBundle#platform.plugin.jog4l.showABCStepSize",
        lazy = false)
@ActionReferences({
        @ActionReference(
...
public class ShowABCStepSizeAction extends AbstractAction implements Presenter.Menu {
    ...
    public ShowABCStepSizeAction() {
        String title = Localization.getString("platform.plugin.jog4l.showABCStepSize");
        putValue(NAME, title);
