 ...
 */
package com.willwinder.ugs.nbp.jog4l.actions;
...
@ActionID(
        ...
        id = "com.willwinder.ugs.nbp.jog4l.actions.UseSeparateStepSizeAction")
@ActionRegistration(
        displayName = "resources.MessagesBundle#platform.plugin.jog4l.useSeparateStepSize",
        lazy = false)
@ActionReferences({
        @ActionReference(
...
public class UseSeparateStepSizeAction extends AbstractAction implements Presenter.Menu {
    ...
    public UseSeparateStepSizeAction() {
        String title = Localization.getString("platform.plugin.jog4l.useSeparateStepSize");
        putValue(NAME, title);
